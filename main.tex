...
\quad\brak{\because \angle B=\angle C}
\\
\angle B=\angle C=35^{\degree}
\end{align}
\begin{align}
\vec{BC}&=2{a}{\cos(35)} \quad\brak{\because a=6.5}
\\
&=10.6
\end{align}
The vertex B can be expressed in polar coordinate form as 
\begin {align}
\vec{B} &= b\myvec{\cos A\\ \sin A}
\end{align}
B can be expressed as 
\begin{align}
&= 6.5\myvec{\ cos 110 \\ \ sin 110}\quad\brak{\because b=6.5}
\\
&= 6.5\myvec{\ -0.34202 \\ \ 0.93969}
\\
&= \myvec{\ -2.22313 \\ \ 6.10798}
\end{align}
So, the vertices of $\triangle ABC$ are
\begin{align}
\vec{A}=\myvec{0\\0},
\vec{C}=\myvec{6.5\\0}, 
\vec{B}=\myvec{-2.22313\\6.10798}
\end{align}
Plot of the Isosceles $\triangle ABC$:
